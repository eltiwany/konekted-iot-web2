...
@Component({
  selector: 'app-delete-boards',
  templateUrl: './delete-boards.component.html',
  styleUrls: ['./delete-boards.component.css']
})
export class DeleteBoardsComponent implements OnInit {
