...
@Component({
  selector: 'app-view-config-sensors',
  templateUrl: './view-config-sensors.component.html',
  styleUrls: ['./view-config-sensors.component.css']
})
export class ViewConfigSensorsComponent implements OnInit {
