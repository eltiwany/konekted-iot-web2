...
@Component({
  selector: 'app-new-config-actuators',
  templateUrl: './new-config-actuators.component.html',
  styleUrls: ['./new-config-actuators.component.css']
})
export class NewConfigActuatorsComponent implements OnInit {
